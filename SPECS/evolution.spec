...
%patch01 -p1 -b .config-lookup-crash
...
* Mon Oct 15 2018 Milan Crha <mcrha@redhat.com> - 3.28.5-5
- Obsolete evolution-tests subpackage (RH bug #1638480)

* Mon Oct 01 2018 Milan Crha <mcrha@redhat.com> - 3.28.5-4
- Add patch for RH bug #1634665 (Deselects task/memo list when started in Calendar view)
...
- Add patch for RH bug #1620582 (Crash under config_lookup_thread() at e-config-lookup.c:179)
...
* Fri Jun 22 2018 Milan Crha <mcrha@redhat.com> - 3.28.3-2
- Disable evolution-tests subpackage, not much maintained upstream and requires python2
